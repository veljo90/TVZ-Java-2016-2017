...
/**
 * Predstavlja entitet prodaje artikla koji je definiran klijentom, artiklom,
 * opisom, datumom, cijenom i statusom usluge
 * 
 * @author Velimir
 *
 */
public class ProdajaArtikla extends Usluga implements Robna {
	 ...
	 * 
	 * @param klijent
	 *            podatak o klijentu koji kupuje artikl
	 * @param vrstaUsluge
	 *            podatak o vrsti usluge
	 * @param opisUsluge
	 *            podatak o opisu usluge
	 * @param datumUsluge
	 *            podatak o datumu usluge
	 * @param cijenaUsluge
	 *            podatak o cijeni usluge
	 * @param obavljena
	 *            podatak da li je usluga obavljena
	 * @param naplacena
	 *            podatak da li je usluga naplaæena
	 * @param artikl
	 *            podatak o artiklu
	 */
