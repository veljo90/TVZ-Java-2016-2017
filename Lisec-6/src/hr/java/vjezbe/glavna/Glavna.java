...
public class Glavna {
	...
	public static void main(String[] args) {
		...
		Boolean ponoviUnos;
		int brUsluga = unesiBrojUsluga(unos);
	...
	public static void unesiKomunikacije(MaloprodajnaTvrtka tvrtka, Scanner unos) {
	...
	public static void ispisiKomunikacije(MaloprodajnaTvrtka tvrtka) {
		int redniBroj = 1;
	 ...
	 * @return
	 */
	public static Usluga unesiUslugu(Klijent klijent, Scanner unos) {
...
//		}
	 ...
	 */
	public static void ispisiKlijente(MaloprodajnaTvrtka tvrtka) {
	...
	public static void ispisiZaposlenike(MaloprodajnaTvrtka tvrtka) {
...
//		}
	 ...
	 */
	public static void ispisiArtikle(MaloprodajnaTvrtka tvrtka) {
		//int redniBroj = 1;
		final AtomicInteger redniBroj = new AtomicInteger(1);
